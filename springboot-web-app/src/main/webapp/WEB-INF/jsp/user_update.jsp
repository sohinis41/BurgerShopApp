	...
	<div id="loginbox" style="margin-top: 50px"
		...
		<div class="panel panel-info">
			...
			<div style="padding-top: 30px" class="panel-body">
				<form:form modelAttribute="userupdate" method="post"
					class="form-horizontal">
					<div style="margin-bottom: 25px" class="input-group">
						<form:input path="email" type="email" placeholder="Enter new email" />
					</div>
					...
					<div style="margin-top: 10px" class="form-group" align="center">
						<div class="col-sm-12 controls">
							<form:button type='success' class="btn btn-success">Update</form:button>
						</div>
